...
public class HR extends Employee {
    ...
    public HR(String firstName, String lastName, String phoneNumber, int uID, double salary, Address address, String password, int cubicle, int workplaceIncidentResponses) {
